...
describe("token-rewards-coupons", async () => {
    ...
    const program = anchor.workspace.TokenRewardsCoupons as Program<TokenRewardsCoupons>;

    const connection = anchor.getProvider().connection;
    let userWallet = new PublicKey("EzEV6RerD5yTVSD8qAV4X3igfQwVYRYSYDFT3BPBwHDm");
    ...
    it("Create a Promo:", async () => {
        ...
        const tx = await program.methods
            .createPromo("https://jsonkeeper.com/b/VQVR", "Burger Coupon", "BURG")
            .accounts({
                merchant: merchant,
                promo: promo,
                promoMint: promoMint,
